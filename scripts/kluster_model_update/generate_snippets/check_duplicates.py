...
def find_duplicate_models(filepath: str) -> List[Tuple[str, List[str]]]:
    """
...
def find_inconsistent_references(markdown_file: str) -> List[Tuple[str, str, str]]:
    """
...
def report_documentation_issues(realtime_md: str, batch_md: str) -> bool:
    """
